...
#             menuItem("Photos uploaded to date", tabName = "photoload", icon = icon("camera")),
             menuItem("Squid weight-size class graphs", tabName = "squidsize", icon = icon("chart-bar")),
             menuItem("Fish size-frequency graphs", tabName = "sizefreqs", icon = icon("chart-bar")),
  ...
  # '))),
           ...
           tabItems(
             ...
             tabItem(tabName = "instructions",
                     fluidRow(
                      h2("Squid data upload interface", align = "center"),
                      tags$ul(
                          tags$h4(paste0(bullet, "  ", 
                                       "The sampler has a single Excel file 
              ...
              fluidRow(                    
                 tabBox(title = "Data checks", width=12,
                    ...
                    id = "datatabset", height = "400px",
                       ...
                       tabPanel(title="Squid weights", div(tableOutput("squidcheck"), class="datacheck")),
