...
sidebar <-   dashboardSidebar(
        ...
        sidebarMenu(
           ...
           menuItem("Sales graphs: basic", tabName = "wongraphs", icon = icon("chart-bar")),
           menuItem("Alternate sales graph (a)", tabName = "wongraphs2", icon = icon("chart-bar")),
           ...
           menuItem("Pipeline graphs (Old)", tabName = "pipegraphs", icon = icon("chart-bar")),
...
#            start = "2019-10-01")),
 ...
 #             plotlyOutput(outputId="stackPipeLY")),
            shinycssloaders::withSpinner(
              plotlyOutput(outputId="stackPipeCumLY", width = "90%", height="700px"))
              )
        ),
